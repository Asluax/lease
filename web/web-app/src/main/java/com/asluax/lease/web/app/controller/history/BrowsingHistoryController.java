package com.asluax.lease.web.app.controller.history;
...
public class BrowsingHistoryController {
    ...
    private Result<Page<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
        ...
        Page<HistoryItemVo> list = browsingHistoryService.pageHistoryItemByUserId(page, LoginUserContext.getLoginUserApp().getUserId());
